...
j2 = RevoluteMDH('a', l1, 'alpha', pi/2);
j2.qlim = pi/180*[-150 130];

j3 = RevoluteMDH('a', l2);
j3.qlim = pi/180*[-30 140];

robot = SerialLink([j1 j2 j3], 'name', 'RRR-NonPlanar')
robot.teach();
...
T_1_2 = Transformation(pi/2, L1, 0, th2) % α₂=π/2，let Z₁ ⟂ Z₂
